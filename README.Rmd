...
which will allow `codemetar` to associate an identifier with the person. This is supported by CRAN if the package is hosted there and an ORCiD logo linking to the ORCid page will be displayed on the package CRAN web page.
